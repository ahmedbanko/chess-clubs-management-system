"""Tests of the password change view."""
...
class PasswordViewTest(TestCase):
    """Unit tests of the password change view."""
    ...
    def test_password_change_unsuccesful_password_confirmation_not_matching(
            self):
        self.client.login(email=self.user.email, password='Password123')
    ...
    def test_password_change_unsuccesful_when_old_password_incorrect(self):
        self.client.login(email=self.user.email, password='Password123')
        self.form_input['password'] = 'WrongPassword123'
        is_password_correct = check_password(self.form_input['password'], self.user.password)
